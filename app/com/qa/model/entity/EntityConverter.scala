...
/**
  * Converts raw model into classes to be used by controllers
  * @author cboucher
  */
object EntityConverter {

  /**
    * Converts raw model into a user object.
  ...
  /**
    * Converts raw model into an address object.
  ...
  /**
    * Converts raw model into a customer order object.
  ...
  /**
    * Converts raw model into a customer order line object.
  ...
  /**
    * Converts raw model into a location object.
  ...
  /**
    * Converts raw model into an item object.
